...
router.get('/getTotalCobradoHoy/:sucursal_id/:fecha', auth, cobro.getTotalCobradoHoy);
router.get('/getCantCobrosHoy/:sucursal_id/:fecha', auth, cobro.getCantCobrosHoy);
router.get('/resumenCobrosCoradorRuta/:sucursal_id/:fecha', auth, cobro.resumenCobrosCoradorRuta);
